  ...
  return (
    <section className="relative overflow-hidden bg-primary-800">
      <div className="mx-auto flex max-w-7xl flex-col items-start gap-4 px-4 py-16 sm:py-24">
        ...
        <p className="max-w-md text-sm text-primary-200 sm:text-base">
      ...
      <div className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-primary-600/30 blur-3xl" />
    </section>
  );
}